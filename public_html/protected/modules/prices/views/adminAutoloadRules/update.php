<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('prices', 'Prices') => array('admin/admin'), Yii::t('prices', 'Automatic loading of prices') => array('admin'), Yii::t('prices', 'Editing rule of loading of a price')));

$this->pageTitle = Yii::t('prices', 'Editing rule of loading of a price');
...
<h1><?= Yii::t('prices', 'Editing rule of loading of a price') ?></h1>

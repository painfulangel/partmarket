<?php
	...
	$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('universal', 'Universal catalog') => array('/universal/admin/admin'), 
													 ...
													 Yii::t('universal', 'Create universal catalog product')));

	$this->pageTitle = Yii::t('universal', 'Create universal catalog product');
?>

<h1><?php echo Yii::t('universal', 'Create universal catalog product'); ?></h1>

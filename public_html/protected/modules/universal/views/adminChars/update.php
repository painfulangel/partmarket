<?php
	...
	$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('universal', 'Universal catalog') => array('/universal/admin/admin'),
													 ...
													 Yii::t('universal', 'Update universal catalog chars')));
	
	$this->pageTitle = Yii::t('universal', 'Update universal catalog chars');
?>

<h1><?php echo Yii::t('universal', 'Update universal catalog chars') ?></h1>

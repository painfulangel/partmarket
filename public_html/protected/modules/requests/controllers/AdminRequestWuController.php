...
class AdminRequestWuController extends Controller {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['RequestWu'])) {
            $model->attributes = $_POST['RequestWu'];
            if ($model->save())
    ...
    public function actionAdmin() {
        $model = new RequestWu('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['RequestWu']))
            $model->attributes = $_GET['RequestWu'];
    ...
    public function loadModel($id) {
        $model = RequestWu::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'request-wu-form') {

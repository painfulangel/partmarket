...
?>
<div class="span4">
    <?php echo $form->dropDownListRow($model, 'supplier', AllSuppliers::model()->getList(), array('class' => 'span2')); ?>
</div>
<div class="span4">
    <?php echo $form->dropDownListRow($model, 'get_status', AllSuppliers::model()->getStateList(), array('class' => 'span2')); ?>
</div>
<div class="clear"></div>
<div class="span4">

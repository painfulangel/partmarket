<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('news', 'News') => array('admin'), Yii::t('news', 'Edit news')));

$this->pageTitle = Yii::t('news', 'Edit news');

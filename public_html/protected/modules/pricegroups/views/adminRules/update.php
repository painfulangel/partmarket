<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('pricegroups', 'Rules') => array('admin'), Yii::t('pricegroups', 'Editing rules')));

$this->pageTitle = Yii::t('pricegroups', 'Editing rules');
...
<h1><?= Yii::t('pricegroups', 'Editing rules') ?></h1>

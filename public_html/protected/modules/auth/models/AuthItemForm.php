...
class AuthItemForm extends CFormModel
{
    ...
    {
        return array(
            'name' => Yii::t('auth_main', 'System name'),
            'description' => Yii::t('auth_main', 'Description'),
            'bizrule' => Yii::t('auth_main', 'Business rule'),
            'data' => Yii::t('auth_main', 'Data'),
            'type' => Yii::t('auth_main', 'Type'),
        );
    }

...
/**
 * Description of KatalogAccessories
 *
 * @author Sergij
 */
class KatalogAccessoriesImportCathegoriasModel extends CFormModel {
    ...
    public function import() {
        ...
        if ($this->fileImport != NULL) {
            ...
            KatalogAccessoriesCathegorias::model()->importTXT(Yii::app()->controller->module->pathFiles . $filename, $this->fileCharset);
    ...
    public function attributeLabels() {
        return array(
            'fileImport' => Yii::t('katalogAccessories', 'Import File'),
            'fileCharset' => Yii::t('katalogAccessories', 'Coding'),
        );
    }

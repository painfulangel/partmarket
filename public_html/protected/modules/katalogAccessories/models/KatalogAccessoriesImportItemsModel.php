 ...
 * @author Sergij
 */
class KatalogAccessoriesImportItemsModel extends CFormModel {
...
//        echo 'fdfdf';
        ...
        if ($this->fileImport != NULL) {
            ...
            KatalogAccessoriesItems::model()->importTXT(Yii::app()->controller->module->pathFiles . $filename, $this->fileCharset);

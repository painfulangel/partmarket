<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogAccessories', 'Catalogue (products)') => array('admin'), Yii::t('katalogAccessories', 'Creating product')));

$this->pageTitle = Yii::t('katalogAccessories', 'Creating product');
...
<h1><?= Yii::t('katalogAccessories', 'Creating product') ?></h1>

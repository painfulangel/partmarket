<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogAccessories', 'catalogue (categories)') => array('admin'), Yii::t('katalogAccessories', 'Edit category')));

$this->pageTitle = Yii::t('katalogAccessories', 'Edit category');
...
<h1><?= Yii::t('katalogAccessories', 'Edit category') ?></h1>

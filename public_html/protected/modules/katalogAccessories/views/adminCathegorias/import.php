<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogAccessories', 'catalogue (categories)') => array('admin'), Yii::t('katalogAccessories', 'Importing categories')));

$this->pageTitle = Yii::t('katalogAccessories', 'Importing categories');
...
<h1><?= Yii::t('katalogAccessories', 'Importing categories') ?></h1>

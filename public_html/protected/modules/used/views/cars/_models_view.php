 ...
 */
?>
<a class="span6 link-model-wrap" href="<?php echo Yii::app()->createUrl('/used/cars/mod', array('brand'=>$model->slug, 'model'=>$data->slug));?>" style="display: inline-block; margin-bottom: 20px;">

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'vendor_code',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'original_num'); ?>
		<?php echo $form->textField($model,'original_num',array('size'=>60,'maxlength'=>255)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'replacement'); ?>
		<?php echo $form->textField($model,'replacement',array('size'=>60,'maxlength'=>255)); ?>
	</div>

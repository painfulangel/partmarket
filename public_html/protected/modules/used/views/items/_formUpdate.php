...
$tabs = array(
	...
	array(
        ...
        'content' => $this->renderPartial('_setsUpdate', array('form' => $form, 'model' => $model), true),
    ),
    array(
        'label' => Yii::t(UsedModule::TRANSLATE_PATH, 'Pictures'),
        'content' => $this->renderPartial('_picturesUpdate', array('form' => $form, 'model' => $model), true),
    ),
	array(
		'label' => Yii::t(UsedModule::TRANSLATE_PATH, 'Applicability'),
		'content' => $this->renderPartial('_applicatUpdate', array('form' => $form, 'model' => $model, 'mod'=>$mod), true),
	),
);

...
$tabs = array(
    array(
        ...
        'content' => $this->renderPartial('_mainAjax', array('form' => $form, 'model' => $model, 'modification'=>$modification, 'node'=>$node, 'unit'=>$unit,), true),
        'active' => true
    ),
    array(
	...
	array(
		...
		'content' => $this->renderPartial('_applicat', array('form' => $form, 'model' => $model, 'mod'=>$mod), true),
	),
);
	...
	<div class="form-actions">
		...
		$this->widget('bootstrap.widgets.TbButton', array(
			...
			/*'ajaxOptions'=>array(
				...
				'dataType'=>'html',
				'live'=>true,
				'success'=>'function(data){$("#unit-form").html(data);console.log("success");}'
			),*/
		));
		?>
	</div>
...
<script>
	...
	$("#used-items-form").on("submit", function(event, jqXHR, settings) {
		...
		$.ajax({
			...
			success: function(data) {
				$("#unit-form").html(data);return false;
			},
			error:  function(jqXHR, textStatus, errorThrown ) {
				$("#unit-form").html(textStatus);
			}
		});
		return false;
	});

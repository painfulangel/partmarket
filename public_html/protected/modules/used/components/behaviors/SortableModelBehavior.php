 ...
 *
 * Доработано: Если нужно сортировать по числовому полю и что бы индексы перестраивались,
 * нужно в модели указывать параметр 'notSave'=>true
...
class SortableModelBehavior extends CActiveRecordBehavior {
    ...
    {
        if($this->findField === 'name')
        {
            $this->owner->dbCriteria->order = '`'.$this->findField.'`';
        }
        else
        {

...
/**
 * This is the model class for table "parsers_api_all".
 *
 * The followings are the available columns in table 'parsers_api_all':
 * @property integer $id
 * @property string $name
 * @property string $supplier_code
 * @property integer $active_state
 */
class ParsersApiAll extends CMyActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'parsers_api_all';
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('name, supplier_code, site_url', 'length', 'max' => 127),
            array('create_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, supplier_code, active_state', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'create_date' => Yii::t('parsersApi', 'Addition date'),
            'site_url' => Yii::t('parsersApi', 'website'),
        );
    }

    public function findNewRecords($array) {
     ...
     * @return ParsersApiAll the static model class
     */

 ...
 */
class WebPaymentsCredit extends CMyActiveRecord
{
    ...
    public function beforeSave()
    {
        if (parent::beforeSave()) {
            if ($this->isNewRecord) {
                $this->description = ($this->order_id) ? 'Order '.($this->prepay ? 'pre' : '').'payment (Credit)' : 'Account replenishment (Credit)';
    ...
    public function rules()
    {
        ...
        return array(
            array(
                'user_id, order_id, prepay, result',
                'numerical',
                'integerOnly' => true
            ),
            array(
            ...
            array(
                'id, start_date, finish_date, user_id, value, auth_key, total_value, order_id, prepay, result',
                'safe',
                'on' => 'search'
            )
        );
     ...
     * @return WebPaymentsCredit the static model class
     */

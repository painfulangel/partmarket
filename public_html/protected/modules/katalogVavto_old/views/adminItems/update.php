<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing goods') => array('admin'), Yii::t('katalogVavto', 'Update good')));

$this->pageTitle = Yii::t('katalogVavto', 'Update good');
...
<h1><?= Yii::t('katalogVavto', 'Update good') ?></h1>

<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing goods') => array('admin'), Yii::t('katalogVavto', 'Создание товара')));

$this->pageTitle = Yii::t('katalogVavto', 'Создание товара');
...
<h1><?= Yii::t('katalogVavto', 'Создание товара') ?></h1>

<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing brands') => array('admin'), Yii::t('katalogVavto', 'Import brands')));

$this->pageTitle = Yii::t('katalogVavto', 'Import brands');
...
<h1><?= Yii::t('katalogVavto', 'Import brands') ?></h1>

 ...
 * @author Sergij
 */
class KatalogVavtoImportBrandsModel extends CFormModel {
    ...
    public function import() {
        ...
        if ($this->fileImport != NULL) {
            ...
            KatalogVavtoBrands::model()->importTXT(Yii::app()->controller->module->pathFiles . $filename, $this->fileCharset);

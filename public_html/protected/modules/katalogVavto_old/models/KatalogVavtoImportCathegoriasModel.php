 ...
 * @author Sergij
 */
class KatalogVavtoImportCathegoriasModel extends CFormModel {
    ...
    public function import() {
        ...
        if ($this->fileImport != NULL) {
            ...
            KatalogVavtoCathegorias::model()->importTXT(Yii::app()->controller->module->pathFiles . $filename, $this->fileCharset);

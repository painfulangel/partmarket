<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'mod',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'engine',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'engine_model',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'engine_obj',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'engine_horse',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'type_year',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textAreaRow($model,'seo_text',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'tecdoc_url',array('class'=>'span5','maxlength'=>127)); ?>

	<?php echo $form->textFieldRow($model,'tecdoc_id',array('class'=>'span5','maxlength'=>127)); ?>

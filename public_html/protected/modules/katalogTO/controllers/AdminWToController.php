...
class AdminWToController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('WTo');
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'wto-form') {

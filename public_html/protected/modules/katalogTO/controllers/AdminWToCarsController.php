...
class AdminWToCarsController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['WToCars'])) {
            $model->attributes = $_POST['WToCars'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('WToCars');
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['WToCars']))
            $model->attributes = $_GET['WToCars'];
    ...
    public function loadModel($id) {
        $model = WToCars::model()->findByPk($id);
        if ($model === null)

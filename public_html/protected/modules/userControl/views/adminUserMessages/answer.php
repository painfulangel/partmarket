<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('messages', 'Register of messages') => '/userControl/adminUserMessages/admin',
												 Yii::t('menu', 'Messages') => array('/userControl/adminUserMessages/messages', 'id_dialog' => $dialog->primaryKey),

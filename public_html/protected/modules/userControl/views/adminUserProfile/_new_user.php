...
//        'action' => array('order', 'step' => 'registration'),
    ...
    <div class="formDiv">
        <div class="emailFieldsDiv">              
            <?php echo $form->textFieldRow($model_profile, 'email', array('class' => 'span5')); ?>
        </div>
        <?php // echo $form->passwordFieldRow($model_profile, 'password', array('class' => 'span4')); ?>

        <?php // echo $form->passwordFieldRow($model_profile, 'passwordRepeat', array('class' => 'span4')); ?>
        ...
        <div class="legal-entity-toggle ">
            <?php
            echo $form->radioButtonListInlineRow($model_profile, 'legal_entity', array('0' => $model_profile->getAttributeLabel('legal_entity1'), '1' => $model_profile->getAttributeLabel('legal_entity2'), '2' => $model_profile->getAttributeLabel('legal_entity3')), array('disabled' . ($model_profile->isNewRecord ? 'off' : 'off') => ($model_profile->isNewRecord ? 'on' : 'off'), 'class' => 'legal-entity-fire-toggle', 'id' => 'legal_entity_id'));
            ?>
        </div>
        <script>
            $(function () {
...
<?php } ?>
        ...
        <div class="form-actions">
            ...
            $this->widget('bootstrap.widgets.TbButton', array(
                'buttonType' => 'submit',
                'type' => 'primary',
                'label' => Yii::t('userControl', 'To create the user'),
            ));
            ?>
        </div>

<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('parsers', 'Parsers/API price') => array('admin'), Yii::t('parsers', 'Create parser')));

$this->pageTitle = Yii::t('parsers', 'Create parser');
...
<h1><?= Yii::t('parsers', 'Create parser') ?></h1>

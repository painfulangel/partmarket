<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing brands')));

$this->pageTitle = Yii::t('katalogVavto', 'Editing brands');
...
<h1><?= Yii::t('katalogVavto', 'Editing brands') ?></h1>

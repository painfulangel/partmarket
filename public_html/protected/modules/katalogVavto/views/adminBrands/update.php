<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing brands') => array('admin'), Yii::t('katalogVavto', 'Update brand')));

$this->pageTitle = Yii::t('katalogVavto', 'Update brand');
...
<h1><?= Yii::t('katalogVavto', 'Update brand') ?></h1>

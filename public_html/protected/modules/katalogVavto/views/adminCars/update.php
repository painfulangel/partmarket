<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing models') => array('admin'), Yii::t('katalogVavto', 'Update model')));

$this->pageTitle = Yii::t('katalogVavto', 'Update model');
...
<h1><?= Yii::t('katalogVavto', 'Update model') ?></h1>

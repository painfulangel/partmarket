<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing models') => array('admin'), Yii::t('katalogVavto', 'Import models')));

$this->pageTitle = Yii::t('katalogVavto', 'Import models');
...
<h1><?= Yii::t('katalogVavto', 'Import models') ?></h1>

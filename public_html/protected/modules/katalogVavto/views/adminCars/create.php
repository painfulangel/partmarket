<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('katalogVavto', 'Editing models') => array('admin'), Yii::t('katalogVavto', 'Create model')));

$this->pageTitle = Yii::t('katalogVavto', 'Create model');
...
<h1><?= Yii::t('katalogVavto', 'Create model') ?></h1>

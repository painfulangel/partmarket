...
class GuayaquilUnit extends GuayaquilTemplate {
	...
	var $closedimage = '/images/laximo/closed.gif';
	var $cartimage = '/images/laximo/cart.gif';
	var $detailinfoimage = '/images/laximo/info.gif';
	var $mouse_wheel = '/images/laximo/mouse_wheel.png';
	var $mouse = '/images/laximo/mouse.png';
	var $lmb = '/images/laximo/lmb.png';
	var $move = '/images/laximo/move.png';
	var $arrow = '/images/laximo/pointer.png';

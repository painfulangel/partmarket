...
//		$filename = YII_DEBUG ? 'bootstrap.css' : 'bootstrap.min.css';
        $filename = $YII_BOOTSTRAP_CLIENT ? 'bootstrap_client.css' : ( YII_DEBUG ? 'bootstrap.css' : 'bootstrap.min.css');
    ...
    public function registerResponsiveCss() {
        ...
        $filename = $YII_BOOTSTRAP_CLIENT ? 'bootstrap-responsive_client.css' : (YII_DEBUG ? 'bootstrap-responsive.css' : 'bootstrap-responsive.min.css');
...
//        $filename = YII_DEBUG ? 'bootstrap.js' : 'bootstrap.min.js';
        $filename = $YII_BOOTSTRAP_CLIENT ? 'bootstrap_client.js' : (YII_DEBUG ? 'bootstrap.js' : 'bootstrap.min.js');

...
class LUser extends CActiveRecord {
    ...
    public function getNameId() {
        ...
        if (isset($this->name)) {
            ...
            $result .= '<' . Yii::t('lily', 'Name not set') . '>';
        }
        $result .= ' (';
        ...
        if (isset($this->id)) {
            ...
            $result .= '<' . Yii::t('lily', 'User id not set') . '>';
        }
        $result .= ')';
        return $result;
    }
    ...
    public function attributeLabels() {
        return array(
            'uid' => Yii::t('lily', 'User id'),
            'state' => Yii::t('lily', 'State of user'),
            'inited' => Yii::t('lily', 'Initialization status'),
        );
    }
    ...
    public static function getStateLabel($user) {
        ...
        switch ($user->state) {
            case self::ACTIVE_STATE:
                return Yii::t('lily', "Active");
                break;
            case self::DELETED_STATE:
                return Yii::t('lily', "Deleted");
                break;
            case self::BANNED_STATE:
                return Yii::t('lily', "Banned");
                break;
            default:
    ...
    public static function getInitedLabel($user) {
        if (!isset($user))
            return null;
        return $user->inited ? Yii::t('lily', "Initialized") : Yii::t('lily', "Not initialized");
    }

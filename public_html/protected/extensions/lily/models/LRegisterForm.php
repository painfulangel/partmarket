...
class LRegisterForm extends CFormModel {
    ...
    public function rules() {
        return array(
            ...
            array('passwordRepeat', 'compare', 'compareAttribute' => 'password', 'message' => Yii::t('lily', 'Passwords are not equal!')),
    ...
    public function inDB($attribute, $params)
    {
        ...
        if (isset($account))
            $this->addError($attribute, Yii::t('lily', "Account with such email already exist."));
    }
    ...
    public function attributeLabels() {
        return array(
            'rememberMe' => Yii::t('lily', 'Remember me after registration'),
            'password' => Yii::t('lily', 'Password'),
            'passwordRepeat' => Yii::t('lily', 'Password Repeat'),
        );
    }

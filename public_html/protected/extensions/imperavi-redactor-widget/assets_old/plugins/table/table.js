        ...
        return {
            getTemplate: function ()
            {
                return String()
                        ...
                        + '<label>Ширина таблицы (px)</label>'
                        + '<input type="text" size="5" value="300" id="redactor-table-width" />'
                        + '<label>Ширина рамки (px)</label>'
                        + '<select   id="redactor-table-border-width" ><option value="0" >Нету рамки</option><option value="1" selected>1px</option><option value="2" >2px</option><option value="3" >3px</option><option value="4" >4px</option><option value="5" >5px</option><option value="6" >6px</option><option value="7" >7px</option><option value="8" >8px</option><option value="9" >9px</option></select>'
                        + '</section>';
            },
            init: function ()
            {
            ...
            insert: function ()
            {
                ...
                var rows = $('#redactor-table-rows').val(),
                        ...
                        $table = $('<table class="redactor_edit_table' + $('#redactor-table-border-width').val() + '" style="width:' + $('#redactor-table-width').val() + 'px" id="table' + tableId + '"><tbody></tbody></table>'),
                        i, $row, z, $column;

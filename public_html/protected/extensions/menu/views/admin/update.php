<?php
$this->breadcrumbs = AdminBreadcrumbs::get(array(Yii::t('menu', 'Menu') => array('admin'), Yii::t('menu', 'Edit menu')));

$this->pageTitle = Yii::t('menu', 'Edit menu');

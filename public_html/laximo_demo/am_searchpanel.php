...
<form name="findByOEM" id="findByOEM" action="am_findoem.php" method="get">
    <div class="g_input">
        ...
        <input name="brand" type="text" id="brand" size="20" style="width:200px;" value="<?php if (array_key_exists('brand', $_GET)) echo htmlspecialchars(trim($_GET['brand']));?>"/>
    </div>
    <div class="g_input">
        <label for="oem">OEM</label>
        <input name="oem" type="text" id="oem" size="20" style="width:200px;" value="<?php if (array_key_exists('oem', $_GET)) echo htmlspecialchars(trim($_GET['oem']));?>"/>
    </div>
    <div class="g_input">
        Search options: 
